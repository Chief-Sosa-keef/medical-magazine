...
return (
    ...
    <div className="footer-container">
        ...
        <div className="contact-item">
            <img src="../src/assets/react.svg" alt="Адрес"   className='img_in_foot'/>
            <span>Санкт-Петербург, ул. Академика Павлова, 12</span>
        </div>
        <div className="contact-item">
            <img src="../src/assets/react.svg" alt="Email"  className='img_in_foot' />
            <span>editor@medscience.ru</span>
        </div>
        <div className="contact-item">
            <img src="../src/assets/react.svg" alt="Телефон"  className='img_in_foot' />
