...
return (
    ...
    <div className="footer-container">
        ...
        <div className="logo-container">
            <img src="../public/react.svg" alt="Логотип" className="dna-logo" />
        ...
        <div className="contact-item">
            <img src="../public/react.svg" alt="Адрес"   className='img_in_foot'/>
            <span>Санкт-Петербург, ул. Академика Павлова, 12</span>
        </div>
        <div className="contact-item">
            <img src="../public/react.svg" alt="Email"  className='img_in_foot' />
            <span>editor@medscience.ru</span>
        </div>
        <div className="contact-item">
            <img src="../public/react.svg" alt="Телефон"  className='img_in_foot' />
