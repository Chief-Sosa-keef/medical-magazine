        ...
        <div className="event-article">
            ...
            <footer className="event-footer">
                <div className="footer-content">
                    <p className="footer-note"><span id='spin-emoji'><img src="/universitet_react/react.svg" alt="Адрес" className='img_in'/></span> Не упустите шанс присоединиться к нам!</p>
